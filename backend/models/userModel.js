...
// Decryption function for githubToken
const decryptToken = (encryptedToken) => {
  const decipher = crypto.createDecipheriv("aes-256-cbc", Buffer.from(secretKey), Buffer.alloc(16, 0));
...
// Method to retrieve decrypted GitHub token
userSchema.methods.getDecryptedGithubToken = function () {
  return decryptToken(this.githubToken);
};
